...
builder.Services.AddTransient<DeviceRequestService>();
builder.Services.AddTransient<DeviceHistoryService>();
builder.Services.AddTransient<DeviceRepairService>();
...
AppConstants.ReportAssetUrl = Configuration["Reports:ReportAssetUrl"];
...
{
    options.KnownProxies.Add(IPAddress.Parse("103.189.235.11"));
});
