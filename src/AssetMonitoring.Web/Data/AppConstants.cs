...
namespace AssetMonitoring.Web.Data
{
    public class AppConstants
    {
        ...
        public const string AppName = "AssetMonitoring.Web";
        ...
        public static string? ReportAssetUrl { get; set; }

        public static readonly string[] StatusPerbaikan = new[]{
"Masuk Workshop",
"Perbaikan",
"Selesai"
        }; 
        
        public static readonly string[] StatusPermohonan = new[]{
"Permohonan",
"Diterima",
"Ditolak"
        }; 
        
        public static readonly string[] JenisDevice = new[]{
"Freezer",
"Generator",
"Rak"
        };public static readonly string[] HistoryTypes = new[]{
"Permohonan",
"DikirimKeMerchant",
"DiterimaMerchant",
"Diperbaiki",
